...
- Name: TM UI 补充 rmtb3lbfd >> C Lead 发布 Action；表格内进行中
- Location: D:\代码\testai_community\frontend\e2e\tm-ui-extra.spec.ts:84:3
...
Call log:
  - waiting for getByTestId('tm-action-subtask')

    at antdSelectByLabel (D:\代码\testai_community\frontend\e2e\helpers.ts:101:16)
    at D:\代码\testai_community\frontend\e2e\tm-ui-extra.spec.ts:93:5
```
...
- banner:
  ...
  - button "moon":
    - img "moon"
  - button "user e2eLb_rmtb3lbfd":
    - img "user"
    - text: e2eLb_rmtb3lbfd
- main:
  ...
  - tabpanel "工作台":
    ...
    - text: 全部（1）
    - combobox
    - text: 【E2E】rmtb3lbfd P2 【E2E】rmtb3lbfd T2 进行中 【E2E】rmtb3lbfd P2/【E2E】rmtb3lbfd D2 本周无 Action 0%
    - img "exclamation-circle"
    - button "操作 down":
      - text: 操作
      - img "down"
    - button "+ Action"
    - text: 测试中 测试开始 08-01 ~ 预计结束 08-01 · 需求：补测 · 负责人 LeadBrmtb3lbfd
    - img "No data"
