...
- Name: TM 三点需求 UI rmtb3i7nn >> 01 Manager：周截止提示可见（设置控件已下线）
- Location: D:\代码\testai_community\frontend\e2e\tm-user-reqs.spec.ts:39:3
...
Call log:
  - navigating to "http://127.0.0.1:3003/login", waiting until "load"
    ...
    at D:\代码\testai_community\frontend\e2e\tm-user-reqs.spec.ts:40:11
```
