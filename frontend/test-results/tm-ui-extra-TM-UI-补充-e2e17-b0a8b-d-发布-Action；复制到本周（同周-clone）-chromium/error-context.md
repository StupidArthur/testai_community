...
- Name: TM UI 补充 e2e1787793423 >> C Lead 发布 Action；复制到本周（同周 clone）
- Location: D:\代码\testai_community\frontend\e2e\tm-ui-extra.spec.ts:81:3
...
Call log:
  ...
  - waiting for locator('.ant-message-notice, .ant-notification-notice').filter({ hasText: 'Action 已保存' }).first()
    ...
    at D:\代码\testai_community\frontend\e2e\tm-ui-extra.spec.ts:93:11
```
...
- banner:
  ...
  - button "moon":
    - img "moon"
  - button "user e2eLb_e2e1787793423":
    - img "user"
    - text: e2eLb_e2e1787793423
- main:
  ...
  - tabpanel "工作台":
    ...
    - text: 全部（1）
    - combobox
    - text: 【E2E】e2e1787793423 P2 【E2E】e2e1787793423 T2 进行中 【E2E】e2e1787793423 P2/【E2E】e2e1787793423 D2 本周无 Action 0%
    - img "exclamation-circle"
    - button "操作 down":
      - text: 操作
      - img "down"
    - button "+ Action"
    - text: 测试中 测试开始 08-01 ~ 预计结束 08-01 · 需求：补测 · 负责人 LeadBe2e1787793423
    - img "No data"
    ...
    - list:
      ...
      - listitem:
        - combobox "Page Size"
        - text: 10 / page
- dialog "新建 Action · 【E2E】e2e1787793423 T2":
  - button "Close":
    - img "close"
  - text: 新建 Action · 【E2E】e2e1787793423 T2
  - paragraph: 该 Task 暂无子需求，请先在 Task 详情维护子需求后再创建 Action
  - text: "* 关联子需求"
  - combobox "* 关联子需求"
  - text: 请先在 Task 详情维护子需求 请选择子需求 * 标题
  - textbox "* 标题": 【E2E】e2e1787793423 A2
  - text: 21 / 300 * 本周负责人
  - combobox "* 本周负责人"
  - text: LeadBe2e1787793423（e2eLb_e2e1787793423） 测试内容
  - textbox "测试内容"
  - text: 0 / 1000 环境
  - textbox "环境"
  - text: 0 / 300
